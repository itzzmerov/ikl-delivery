...
const ContactUs = () => (
    <section className="bg-darkBlack text-lightWhite -center md:text-left flex items-center justify-center" id="contact">
        <div className='p-8 text flex flex-col md:flex-row items-center justify-center w-full md:w-[85%] my-16'>
            <div className="space-y-4 w-full md:w-[50%] p-8 flex flex-col items-center md:items-start gap-2">
            ...
            <div className="mt-4 md:ml-6 w-full md:w-[40%] flex flex-col justify-center items-center gap-4 md:gap-2 p-6 md:p-10">
