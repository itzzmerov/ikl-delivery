        ...
        <section className="bg-lightWhite p-8 md:text-left flex flex-col md:flex-row justify-center items-center" id="about">
            <div className='flex flex-col md:flex-row justify-center items-center w-[90%] mt-16'>
                ...
                <div className='w-[50%] flex flex-col gap-5'>
                    ...
                    <button className="mt-4 border-darkBlack border-[3px] hover:bg-darkBlack hover:text-lightWhite w-[40%] px-6 py-2 rounded-full font-Montserrat text-[18px] font-semibold  flex items-center justify-center gap-1"><MenuBookIcon /> Learn More</button>
                </div>
            </div>
        </section>
    );
